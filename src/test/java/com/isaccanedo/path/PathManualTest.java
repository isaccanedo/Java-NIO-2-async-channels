...
public class PathManualTest {
    ...
    public void givenPathString_whenCreatesPathObject_thenCorrect() {
        Path p = Paths.get("/articles/isaccanedo");
        assertEquals("\\articles\\isaccanedo", p.toString());
    ...
    public void givenPath_whenRetrievesFileName_thenCorrect() {
        Path p = Paths.get("/articles/isaccanedo/logs");
    ...
    public void givenPath_whenRetrievesNameByIndex_thenCorrect() {
        ...
        assertEquals("isaccanedo", p.getName(1).toString());
    ...
    public void givenPath_whenCanRetrieveSubsequenceByIndex_thenCorrect() {
        ...
        assertEquals("articles\\isaccanedo", p.subpath(0, 2).toString());
        assertEquals("articles\\isaccanedo\\logs", p.subpath(0, 3).toString());
        assertEquals("isaccanedo", p.subpath(1, 2).toString());
        assertEquals("isaccanedo\\logs", p.subpath(1, 3).toString());
        assertEquals("logs", p.subpath(2, 3).toString());
    }

    @Test
    public void givenPath_whenRetrievesParent_thenCorrect() {
        Path p1 = Paths.get("/articles/isaccanedo/logs");
        Path p2 = Paths.get("/articles/isaccanedo");
        Path p3 = Paths.get("/articles");
        Path p4 = Paths.get("/");

        assertEquals("\\articles\\isaccanedo", p1.getParent().toString());
    ...
    public void givenPath_whenRetrievesRoot_thenCorrect() {
        Path p1 = Paths.get("/articles/isaccanedo/logs");
        Path p2 = Paths.get("c:/articles/isaccanedo/logs");
    ...
    public void givenPath_whenRemovesRedundancies_thenCorrect1() {
        Path p = Paths.get("/home/./isaccanedo/articles");
        p = p.normalize();
        assertEquals("\\home\\isaccanedo\\articles", p.toString());
    }
    ...
    public void givenPath_whenConvertsToBrowseablePath_thenCorrect() {
        Path p = Paths.get("/home/isaccanedo/articles.html");
        URI uri = p.toUri();
        assertEquals("file:///E:/home/isaccanedo/articles.html", uri.toString());
    }

    @Test
    public void givenPath_whenConvertsToAbsolutePath_thenCorrect() {
        Path p = Paths.get("/home/isaccanedo/articles.html");
        assertEquals("E:\\home\\isaccanedo\\articles.html", p.toAbsolutePath().toString());
    }

    @Test
    public void givenAbsolutePath_whenRetainsAsAbsolute_thenCorrect() {
        Path p = Paths.get("E:\\home\\isaccanedo\\articles.html");
        assertEquals("E:\\home\\isaccanedo\\articles.html", p.toAbsolutePath().toString());
    }
    ...
    public void givenTwoPaths_whenJoinsAndResolves_thenCorrect() throws IOException {
        Path p = Paths.get("/isaccanedo/articles");
        assertEquals("\\isaccanedo\\articles\\java", p.resolve("java").toString());
    }

    @Test
    public void givenAbsolutePath_whenResolutionRetainsIt_thenCorrect() throws IOException {
        Path p = Paths.get("/isaccanedo/articles");
        assertEquals("C:\\isaccanedo\\articles\\java", p.resolve("C:\\isaccanedo\\articles\\java").toString());
    }
    ...
    public void givenNonSiblingPaths_whenCreatesPathToOther_thenCorrect() throws IOException {
        Path p1 = Paths.get("/isaccanedo");
        Path p2 = Paths.get("/isaccanedo/authors/articles");
    ...
    public void givenTwoPaths_whenTestsEquality_thenCorrect() throws IOException {
        Path p1 = Paths.get("/isaccanedo/articles");
        Path p2 = Paths.get("/isaccanedo/articles");
        Path p3 = Paths.get("/isaccanedo/authors");
    ...
    public void givenPath_whenInspectsStart_thenCorrect() {
        Path p1 = Paths.get("/isaccanedo/articles");
        assertTrue(p1.startsWith("/isaccanedo"));
    }
